...
# plot that
plot(hs.best, breaks=c(0,11,22,33,43,65,87,109,130,152,174,196,217,239,261,283,304,326,348,370,391,413,435,457,478,500),main="Harbour seal (in water)",style="comp")
...
# plot that
plot(hp.best, breaks=c(0,20,40,61,82,124,166,208,250,291,333,375,416,458,500),main="Harbour porpoise",style="comp")
...
# plot that
plot(hb.best, breaks=c(0, 83.5, 167, 250.5, 333, 500, 667, 833, 1000, 1167, 1333, 1500, 1667, 1833, 2000),main="Humpback",style="comp")
...
grab_results(hp.best)
grab_results(hb.best)
