...
\end{equation*}
where $b_j$ is the \textit{shape parameter}.
...
\caption{Simulation results: stacked bar charts showing the number of models selected by AIC that fall into the given model classes}
\label{sim-barplot}
\end{figure}
...
Before analysing the wood ant data the nest size variable was standardised by

*** Dave: I took out some text defining the variabels for wood ants, and also saying you standardized the nest size -- you might want to put it in here?  Ditto for Amakahi - the species codes and the fact that you standardized the minutes after sunrise.  These codes aren't used in the main text, which is why I took them out.  But I guess you need them here to make sense of the tables.
 ***
