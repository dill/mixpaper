...
Before analysing the wood ant and amakahi data the variables nest size (for ants) and minutes after sunrise (for amakahi) were standardised by dividing the variable by its standard error. Below are plots of the best mixture detection functions for these two analysis.
