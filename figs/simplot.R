...
mtext("Probability of detection",side=2,outer=TRUE,at=c(0.13),las=3,cex=0.7)
mtext("Probability of detection",side=2,outer=TRUE,at=c(0.38),las=3,cex=0.7)
mtext("Probability density",side=2,outer=TRUE,at=c(0.63),las=3,cex=0.7)
mtext("Probability of detection",side=2,outer=TRUE,at=c(0.88),las=3,cex=0.7)
