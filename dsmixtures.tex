...
\begin{enumerate}
	...
	\item Non-covariate 3-point detection functions for line transect data: two different detection functions were used. They are shown in the third row of figure \ref{sim-detfcts}. TKTKTK more
