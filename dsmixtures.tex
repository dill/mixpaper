...
\begin{enumerate}
	...
	\item Non-covariate 2-point detection functions for point transect data:  the detection functions were as above, with data generated as if it came from point transects. The pdfs are given in the second row of figure \ref{sim-detfcts}. TKTKTK say something about which are hard
...
\hline
\hline
Harbour seal (in water) & 1-point Hn+cos(2) (W\&T) & 500 & 2771.05 & 0.425 & 7.55 & 0.515\\
 & 2-point & 500 & 2769.86 & 0.335 & 14.8 & 0.945\\
...
Hn 2-pt & species+habitat & 749.05 & 0.027 & 38.7 & 0.94\\ 
