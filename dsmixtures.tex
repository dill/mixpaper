...
\hline
Amakihi  & Hr obs + mas & 0.00 &  0.319 & 5.11 & 0.08\\ % mrds
\hline
...
\bibitem{Buckland:2001vm}
Buckland ST, Anderson DR, Burnham KP, Laake JL, Borchers DL, et~al. (2001)
  {Introduction to Distance Sampling}.
\newblock Oxford University Press.
\bibAnnoteFile{Buckland:2001vm}

\bibitem{Buckland:2004ts}
Buckland ST, Anderson DR, Burnham KP, Laake JL, Borchers DL, et~al. (2004)
  {Advanced Distance Sampling}.
\newblock Oxford University Press.
\bibAnnoteFile{Buckland:2004ts}

\bibitem{Buckland:1992wy}
Buckland ST (1992) {Fitting density functions with polynomials}.
\newblock Journal of the Royal Statistical Society Series C: Applied Statistics
  41: 63--76.
\bibAnnoteFile{Buckland:1992wy}

\bibitem{Thomas:2010cf}
Thomas L, Buckland ST, Rexstad EA, Laake JL, Strindberg S, et~al. (2010)
  {Distance software: design and analysis of distance sampling surveys for
  estimating population size}.
\newblock Journal of Applied Ecology 47: 5--14.
\bibAnnoteFile{Thomas:2010cf}

\bibitem{Team:2013wf}
{R Core Team} (2013) {R: A Language and Environment for Statistical Computing}.
\newblock Vienna, Austria.
\newblock \urlprefix\url{http://www.R-project.org/}.
\bibAnnoteFile{Team:2013wf}

\bibitem{mrds}
Laake JL, Borchers DL, Thomas L, Miller DL, Bishop JR (2014) mrds:
  Mark-Recapture Distance Sampling (mrds).
\newblock \urlprefix\url{http://CRAN.R-project.org/package=mrds}.
\newblock R package version 2.1.6.
\bibAnnoteFile{mrds}

\bibitem{Marques:2003vb}
Marques F, Buckland ST (2003) {Incorporating covariates into standard line
  transect analyses}.
\newblock Biometrics 59: 924--935.
\bibAnnoteFile{Marques:2003vb}

\bibitem{Schittkowski:1986wj}
...
\bibAnnoteFile{Schittkowski:1986wj}
...
\bibAnnoteFile{Pike:2003ug}

\bibitem{Pledger:2000tc}
...
\bibAnnoteFile{Pledger:2000tc}

\bibitem{Dorazio:2003uf}
...
\bibAnnoteFile{Dorazio:2003uf}

\bibitem{Pledger:2005wy}
...
\bibAnnoteFile{Pledger:2005wy}

\bibitem{Morgan:2008wy}
Morgan BJT, Ridout MS (2008) {A new mixture model for capture heterogeneity}.
\newblock Journal of the Royal Statistical Society Series C: Applied Statistics
  57: 433--446.
\bibAnnoteFile{Morgan:2008wy}
...
\bibAnnoteFile{Distance}

\bibitem{Williams:2007tc}
...
\bibAnnoteFile{Williams:2007tc}

\bibitem{Borkin:2012vj}
...
\bibAnnoteFile{Borkin:2012vj}

\bibitem{Laake:2004tz}
...
\newblock In: Buckland ST, anderson DR, Burnham KP, Laake JL, Borchers DL,
  ...
  48--70.
\bibAnnoteFile{Laake:2004tz}

\bibitem{Laake:2011vm}
...
\newblock Journal of Agricultural, Biological, and Environmental Statistics 16:
  389--408.
\bibAnnoteFile{Laake:2011vm}

\bibitem{Hedley:2004et}
...
\newblock Journal of Agricultural, Biological, and Environmental Statistics 9:
  181--199.
\bibAnnoteFile{Hedley:2004et}

\bibitem{Miller:2013us}
...
\bibAnnoteFile{Miller:2013us}

\bibitem{Borchers:2010bq}
...
\bibAnnoteFile{Eidous:2011}

\bibitem{Giammarino:2014eg}
...
\bibAnnoteFile{Giammarino:2014eg}
