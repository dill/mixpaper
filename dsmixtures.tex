...
&&&&&\\
Long-finned & Hn + $\cos(2)$ \texttt{BSS} (cont.) & 1286.5 & 0.452 & 8.69 & 0.48\\ % mrds
...
pilot whales  & Hn 2-pt &  1298.42  &  0.295  &  17.17  &  0.95 \\
 ...
 &&&&&\\
Wood ants & Hr \texttt{nest.size} + \texttt{habitat} & 743.56 & 0.195  & 21.72 & 0.89\\ % mrds result
% & Hr  \texttt{nest.size} + \texttt{habitat} & 745.2 & 0.194 & 10.6 & 0.95\\  % Distance result 
 ...
 &&&&&\\
Amakihi  & Hr \texttt{obs} + \texttt{mas} & \textbf{10777.38} &  0.319 & 5.11 & 0.08\\ % mrds
