...
[Dave - the final submitted version needs to be 25 pages long or less.  Can you work it so that some figures share a page (e.g., 4, 5, 6) so that we meet the limits?  I don't know how to do this]
...
So, we need to note that we have more than typical, and exlain why. OR we could take matters into our own hands, and move e.g., figures 5 and 7 to an appendix?]

[Dave - when I build this to a dvi, I get a footnote after the abstract and keywords that says (c) The Society for the Study of Evolution.  All rights reserved.  Any idea what this is about and what to do about it?  Maybe it's just me and I'm using a screwed up style file??]

[Dave - note - if we get desperate for space, then uncommenting the Times font option in the preamble above results in a slightly shorter document]
